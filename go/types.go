...
// Request contains the parameters for the Stock Index API.
//
// Parameters:
...
func (r *Request) Validate() error {
	rules := map[string]ValidationRule{
		...
		"year": {Type: "integer", Required: false, Min: float64Ptr(2010), Max: float64Ptr(2030)},
	}
...
// ResponseData contains the data returned by the Stock Index API.
