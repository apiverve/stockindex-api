// Package stockindex provides a Go client for the Stock Index API.
//
// For more information, visit: https://apiverve.com/marketplace/stockindex?utm_source=go&utm_medium=readme
package stockindex
...
const (
	baseURL        = "https://api.apiverve.com/v1/stockindex"
	defaultTimeout = 30 * time.Second
)

// Client is the Stock Index API client.
type Client struct {
	apiKey     string
	httpClient *resty.Client
}

// NewClient creates a new Stock Index API client.
...
// Execute makes a request to the Stock Index API with typed parameters.
//
...
//   - index (required): string - The index to retrieve
//   - year: integer - Specific year to retrieve all daily values for (2010-present). Returns latest if not specified. [min: 2010, max: 2030]
