...
#endif
    {
        private readonly string _apiEndpoint = "https://api.apiverve.com/v1/stockindex";
        ...
        {
            { "index", new ValidationRule { Type = "string", Required = true } },
            { "year", new ValidationRule { Type = "integer", Required = false, Min = 2010, Max = 2030 } }
        };
        ...
        public StockIndexAPIClient(string apiKey)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public StockIndexAPIClient(string apiKey, bool isSecure, bool isDebug)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public StockIndexAPIClient(string apiKey, bool isSecure, bool isDebug, HttpClient httpClient)
        {
        ...
        public void ExecuteAsync(ExecuteAsyncCallback callback, StockIndexQueryOptions options = null)
        {
            if (callback == null)
            {
        ...
        private void ValidateParams(StockIndexQueryOptions options)
        {
        ...
        public ResponseObj Execute(StockIndexQueryOptions options = null)
        {
        ...
        public Task<ResponseObj> ExecuteAsync(StockIndexQueryOptions options = null)
        {
        ...
        public async Task<ResponseObj> ExecuteAsync(StockIndexQueryOptions options, CancellationToken cancellationToken)
        {
            int attempt = 0;
        ...
        /// </summary>
        private async Task<ResponseObj> ExecuteRequestAsync(StockIndexQueryOptions options, CancellationToken cancellationToken)
        {
            try
            {
        ...
        /// </summary>
        private ResponseObj ExecuteWithWebRequest(StockIndexQueryOptions options)
        {
            int attempt = 0;
            Exception lastException = null;
        ...
        /// </summary>
        private ResponseObj ExecuteWebRequestInternal(StockIndexQueryOptions options)
        {
            try
            {
                Log("Executing API request...");
        ...
        /// </summary>
        private string ConstructURL(StockIndexQueryOptions options)
        {
