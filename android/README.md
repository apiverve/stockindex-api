...
```gradle
dependencies {
    implementation 'com.github.apiverve:stockindex-api:1.1.13'
}
```
...
```java
import com.apiverve.stockindex.StockIndexAPIClient;
import com.apiverve.stockindex.APIResponse;
import com.apiverve.stockindex.APIException;

// Initialize the client
StockIndexAPIClient client = new StockIndexAPIClient("YOUR_API_KEY");

try {
    // Prepare query parameters
    Map<String, Object> parameters = new HashMap<>();
    parameters.put("index", "sp500");
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/stockindex](https://docs.apiverve.com/ref/stockindex)
...
- **Documentation:** [https://docs.apiverve.com/ref/stockindex](https://docs.apiverve.com/ref/stockindex)
- **Issues:** [GitHub Issues](https://github.com/apiverve/stockindex-api/issues)
